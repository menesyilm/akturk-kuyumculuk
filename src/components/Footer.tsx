      ...
      <div className="max-w-8xl mx-auto px-3 sm:px-4 lg:px-6 xl:px-8 py-4 sm:py-6 lg:py-8 xl:py-10 border-t-2 border-brand-gold">
        ...
        <div className="flex flex-col md:flex-row gap-4 md:gap-6 lg:gap-8 md:items-stretch">
          ...
          <div className="flex flex-col justify-between flex-1">
            ...
            {/* Sosyal İkonlar - Sadece Mobilde Logo Altında */}
            <motion.div variants={panelVariants} initial="hidden" whileInView="visible" viewport={{ once: false, margin: "100px" }}
              className="flex md:hidden gap-3 my-3"
            >
            ...
            <div className="flex flex-col sm:flex-row gap-6 sm:gap-10 lg:gap-14">
              ...
              <motion.div variants={panelVariants} initial="hidden" whileInView="visible" viewport={{ once: false, margin: "100px" }} className="space-y-1.5">
                <h3 className="text-xs sm:text-sm lg:text-base xl:text-lg font-bold text-brand-gold">Bize Ulaşın</h3>
                <div className="space-y-1">
                  <a href="mailto:official@akturkkuyumculuk.com" className="flex items-center gap-1.5 sm:gap-2 text-brand-light-gray hover:text-brand-gold transition-colors text-[10px] sm:text-xs lg:text-sm">
                    <Mail className="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0" />
                    <span>official@akturkkuyumculuk.com</span>
                  </a>
                  <a href="tel:05312831934" className="flex items-center gap-1.5 sm:gap-2 text-brand-light-gray hover:text-brand-gold transition-colors text-[10px] sm:text-xs lg:text-sm">
                    <Phone className="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0" />
                    <span>+90 531 283 19 34</span>
                  </a>
                  <a href="tel:04623321661" className="flex items-center gap-1.5 sm:gap-2 text-brand-light-gray hover:text-brand-gold transition-colors text-[10px] sm:text-xs lg:text-sm">
                    <Phone className="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0" />
